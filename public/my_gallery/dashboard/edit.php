  ...
  class Edit
{
  ...
  function __construct($a)
  {
    ...
    $query= "SELECT * FROM images WHERE id='$user_id'";
          ...
          <div class="row ">
            ...
            <div class="col py-5">
              <form method="post" action="update.php" enctype="multipart/form-data">
              	...
              	<input type="hidden" name="id" value="<?php echo($object->rowdata->id)?>">
                

                <div class="row">
                  <div class="col-md-4">
                    <p> <img src="<?php echo($object->rowdata->image_path)?>"> </p>
                    <p> <input type="text" name="image_name" value="<?php echo ($object->rowdata->image_name) ?>">
                    </p>
                    ...
                    <p class="py-5">
                      ...
                      <p><input type="submit" name="upload" value="upload" class="btn btn-warning"></p>

                    <p class="py-3"><a href="view.php" class="btn btn-info" type="submit"> View</a></p>
                  </div>
                </div>
              </form>
            </div>
