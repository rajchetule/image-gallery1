  ...
  class Cat_nature 
{
  ...
  function __construct()
  {
    ...
    $query= "SELECT images. * ,categories.category_name FROM images INNER JOIN categories ON images.category_id=categories.id WHERE images.category_id=1";
      ...
      <div class="row py-4">
        <div class="col">
          <ul class="nav justify-content-center">
            <li class="nav-item">
              <a class="nav-link active" href="nature_pic.php">NATURE</a>
            </li>
            <li class="nav-item">
