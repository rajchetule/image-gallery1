 ...
 class Cat_travel 
{
  ...
  function __construct()
  {
    ...
    $query= "SELECT images. * ,categories.category_name FROM images INNER JOIN categories ON images.category_id=categories.id WHERE images.category_id=4";
      ...
      <div class="row py-4">
        <div class="col">
          <ul class="nav justify-content-center">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="travel_pic.php">TRAVEL</a>
            </li>
            <li class="nav-item">
