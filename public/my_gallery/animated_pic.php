  ...
  class Cat_travel 
{
  ...
  function __construct()
  {
    ...
    $query= "SELECT images. * ,categories.category_name FROM images INNER JOIN categories ON images.category_id=categories.id WHERE images.category_id=5";
            ...
            <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="img/banner_img/img1.jpg" class="d-block w-100 img-fluid" alt="...">
      ...
      <div class="row py-4">
        <div class="col">
          <ul class="nav justify-content-center">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="fashion_pic.php">FASHION</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="food_pic.php">FOOD</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        <?php 
         ...
         $obj=new Cat_travel($_POST);

          // while ($data=$result->fetch_object()){
          // echo "<div class='col-md-4 pb-4'>";
          //   echo "<img src='dashboard/$data->image_path' class='img-fluid' <br>";
          //   echo "<p>$data->image_name</p>";
          //   echo "<p><a href='download.php?path=dashboard/$data->image_path' class='btn btn-info btn-md'>Download</a></p> <br>";
