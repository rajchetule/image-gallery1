  ...
  class Cat_fash 
{
  ...
  function __construct()
  {
    ...
    $query= "SELECT images. * ,categories.category_name FROM images INNER JOIN categories ON images.category_id=categories.id WHERE images.category_id=2";
