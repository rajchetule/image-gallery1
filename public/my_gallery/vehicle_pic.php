...
class Cat_vehicle 
{
  ...
  function __construct()
  {
    ...
    $query= "SELECT images. * ,categories.category_name FROM images INNER JOIN categories ON images.category_id=categories.id WHERE images.category_id=3";
      ...
      <div class="row py-4">
        <div class="col">
          <ul class="nav justify-content-center">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="vehicle_pic.php">VEHICLE</a>
            </li>
            <li class="nav-item">
